...
export function useOperationsDashboardFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsDashboardFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_dashboard.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsDashboardCount<T extends Prisma.operations_dashboardCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.operations_dashboardCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsDashboardCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_dashboard.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsDashboardFindManyWithCount<
  T extends Prisma.operations_dashboardFindManyArgs,
  R extends { data: GetFindResult<Prisma.$operations_dashboardPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.operations_dashboardFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsDashboardFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_dashboard.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationsDashboardFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationsDashboardFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operations_dashboard.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
